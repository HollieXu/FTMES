Public Class frmUtiRunOpen


    Private Sub frmUtiRunOpen_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Me.Left = 10
        Me.Top = 10
        Me.BackColor = mydefaultcolor

        txt_FormNo.Text = "UTR" + Format(Now(), "yyyyMMddHHmmss")
    ...
    Private Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        ...
        mysql = "INSERT INTO UtiRunTrack (SN,tester,iLot,cust,cLot,iprod,step,wqty,Temp,TempChange,Probecard,PIB,Program,starttime) VALUES ( '" &
