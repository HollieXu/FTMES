...
Public Class frmCheckInQC

    Private Sub frmCheckInQC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        ...
        If SelectedQty <> mycheckio.waferqty Then
            MsgBox("异常:勾选总片数与收货总片数不一致! 无法进站", vbOKOnly + vbExclamation)
            Exit Sub
        End If

        '更新WIPLOT表WaferList信息
        If SetWIPLotWaferList(mycheckio.ilot, waferliststr) = False Then
            MsgBox("Check In 失败,更新WIPLOT表WaferList信息FAIL, 无法进站!", vbOKOnly + vbExclamation)
            Exit Sub
        Else
            'do nothing
        End If
    ...
    Private Sub combo_equiptype_DropDown(sender As Object, e As EventArgs) Handles combo_equiptype.DropDown
        ...
        If mydataset.Tables("Equipment").Rows.Count = 0 Then
            ...
            combo_equiptype.Items.Add("Query Fail !")
    ...
    Private Sub combo_equiptype_SelectedIndexChanged(sender As Object, e As EventArgs) Handles combo_equiptype.SelectedIndexChanged
        ...
        If mydataset.Tables("Equipment").Rows.Count = 0 Then
            combo_equipid.Items.Add("Query Fail !")
        Else
